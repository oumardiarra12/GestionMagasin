...
class UpdateReglementFournisseurRequest extends FormRequest
{
    /**
    ...
    {
        return [
            "ReferenceRegF" => ["required", "max:50", Rule::unique('reglementfournisseurs', 'ReferenceRegF')->ignore($this->reglementfournisseur)],
