...
class StoreArticleRequest extends FormRequest
{
    ...
    {
        return [
            'ReferenceArticle' => 'required|min:2|max:50|unique:articles',
            'CodeBarre' => 'nullable|numeric|min:13|unique:articles',
...

    {
        ...
        return [
            ...
            'CodeBarre.unique' => 'Le Code Barre doit etre unique.',
